...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      <Title title='Featured Destination' subTitle='Discover our handpicked selection of exceptional properties around the world, offering unparralled luxury and unforgetable experirnces'/>
