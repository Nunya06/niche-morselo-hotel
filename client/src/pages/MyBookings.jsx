...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <Title title='My Bookings' subTitle='Easily manage your past, current, and future hotel reservations in one place. Plan your trips seamlessly with just a few clicks' align='left' />
                    ...
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        <div className='flex flex-col md:flex-row'>
                            ...
                            <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                                ...
                                <div className='flex items-center gap-1 text-sm text-gray-500'>
                                    <img src={assets.guestsIcon} alt="guestIcon" className='' />
