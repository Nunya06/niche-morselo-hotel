...
const AddRoom = () => {
    ...
    return (
        <form >
            <Title align='left' title='Add Room' subTitle='Details of room, pricing and amenities to enhance user experience' />
            ...
            <div className='w-full flex mas-sm:flex-col sm:gap-4 mt-4'>
            ...
            <p className='mt-4 text-gray800'>Amenities</p>
