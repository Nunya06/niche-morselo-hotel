...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title align='left' title='Dashboard' subTitle='Monitor your room listing, track bookings and analyze revenue in one place. Stay updated with real-time insights to ensure smooth operations.' />
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="py-3 px-4 text-gray-300 border-t flex">
